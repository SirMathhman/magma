...
public struct CommonLang {public static final String NAMESPACED_BEFORE="before";public static final String NAMESPACED_AFTER="after";public static final String ROOT_TYPE="root";public static final String RECORD_TYPE="record";public static final String CLASS_TYPE="class";public static final String INTERFACE_TYPE="interface";public static final String BEFORE_STRUCT_SEGMENT="before-struct-segment";public static final String STRUCT_TYPE="struct";public static final String WHITESPACE_TYPE="whitespace";public static final String STRUCT_AFTER_CHILDREN="struct-after-children";public static final String BLOCK_AFTER_CHILDREN="block-after-children";public static final String BLOCK="block";public static final String CONTENT_BEFORE_CHILD="before-child";public static final String PARENT="caller";public static final String GENERIC_CHILDREN="children";public static final String FUNCTIONAL_TYPE="functional";public static final String METHOD_CHILD="child";public static final String DEFINITION_ANNOTATIONS="annotations";public static final String DEFINITION_MODIFIERS="modifiers";public static final String METHOD_TYPE="method";public static final String INITIALIZATION_TYPE="initialization";public static final String METHOD_DEFINITION=INITIALIZATION_TYPE;public static final String INITIALIZATION_VALUE="value";public static final String INITIALIZATION_DEFINITION="definition";public static final String DEFINITION_TYPE="definition";public static final String TUPLE_TYPE="tuple";public static final String TUPLE_CHILDREN="children";public static final String CONTENT_AFTER_CHILD="after-child";public static Rule createNamespacedRule(String type, String prefix){
