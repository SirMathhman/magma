...
static Rule createCompoundRule(String type, String infix, Rule segmentRule){
	...
	const auto maybeModifiers=new OptionalNodeRule("modifiers", new SuffixRule(modifiers, " "));
...
static StripRule createStructSegmentRule(LazyRule function, Rule statement){
...
static Rule createMethodRule(Rule statement){
	const auto orRule=new OptionalNodeRule(METHOD_CHILD, new NodeRule(METHOD_CHILD, createBlockRule(statement)), new ExactRule(";"));
	const auto definition=createDefinitionRule();
	const auto definitionProperty=new NodeRule(METHOD_DEFINITION, definition);
	const auto params=new OptionalNodeListRule("params", new DivideRule("params", VALUE_DIVIDER, definition));
...
static TypeRule createInvocationRule(Rule value){
	...
	const auto children=new OptionalNodeListRule("children", new DivideRule("children", VALUE_DIVIDER, value));
...
static TypeRule createLambdaRule(Rule statement, LazyRule value){
	const auto args=new StripRule(new OrRule(List.of(new ExactRule("()"), new NodeRule("arg", createSymbolRule()), new DivideRule("args", new SimpleDivider(","), createSymbolRule()))));
...
static TypeRule createConstructionRule(LazyRule value){
	...
	const auto arguments=new OptionalNodeListRule("arguments", new DivideRule("arguments", VALUE_DIVIDER, value));
...
static Rule createDefinitionRule(){
	...
	const auto withModifiers=new OptionalNodeListRule("modifiers", new ContextRule("With modifiers", new StripRule(new InfixRule(modifiers, new BackwardsLocator(" "), maybeTypeParams))), new ContextRule("Without modifiers", maybeTypeParams));
...
static TypeRule createFunctionalRule(Rule type){
	const auto params=new OptionalNodeListRule("params", new DivideRule("params", VALUE_DIVIDER, type));
...
struct CommonLang {static const String ROOT_TYPE="root";static const String RECORD_TYPE="record";static const String CLASS_TYPE="class";static const String INTERFACE_TYPE="interface";static const String BEFORE_STRUCT_SEGMENT="before-struct-segment";static const String STRUCT_TYPE="struct";static const String WHITESPACE_TYPE="whitespace";static const String STRUCT_AFTER_CHILDREN="struct-after-children";static const String BLOCK_AFTER_CHILDREN="block-after-children";static const String BLOCK="block";static const String CONTENT_BEFORE_CHILD="before-child";static const String PARENT="caller";static const String GENERIC_CHILDREN="children";static const String FUNCTIONAL_TYPE="functional";static const String METHOD_CHILD="child";static const String DEFINITION_ANNOTATIONS="annotations";static const String METHOD_TYPE="method";static const String INITIALIZATION_TYPE="initialization";static const String METHOD_DEFINITION="definition";static const String INITIALIZATION_VALUE="value";static const String INITIALIZATION_DEFINITION="definition";static const String DEFINITION_TYPE="definition";static const String TUPLE_TYPE="tuple";static const String TUPLE_CHILDREN="children";static const String CONTENT_AFTER_CHILD="after-child";
}
