...
public struct DivideRule implements Rule {
	...
	public DivideRule(String propertyKey,  Divider divider,  Rule childRule){this.divider =divider;this.childRule =childRule;this.propertyKey =propertyKey;}
	...
	private String merge(List<String> elements){return Streams.from(elements)
