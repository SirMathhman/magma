...
public struct PrefixRule implements Rule {
	...
	public PrefixRule=public PrefixRule(String prefix, Rule childRule){
		this.prefix =prefix;
		this.childRule =childRule;
	};
	Result<String, CompileError> truncateLeft=Result<String, CompileError> truncateLeft(String input, String slice){
