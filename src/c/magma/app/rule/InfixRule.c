package magma.app.rule;package magma.api.Tuple;package magma.api.result.Err;package magma.api.result.Ok;package magma.api.result.Result;package magma.app.Node;package magma.app.error.CompileError;package magma.app.error.context.StringContext;package magma.app.locate.Locator;public final class InfixRule implements Rule {private final Rule leftRule;private final Locator locator;private final Rule rightRule;public InfixRule(Rule leftRuleRule leftRule Locator locatorRule leftRule Locator locator Rule rightRule){this.leftRule = leftRule;this.locator = locator;this.rightRule = rightRule;}public static Result<Tuple<String, String>, CompileError> split(Locator locatorLocator locator String input){return locator.locate(input).<Result<Tuple<String, String>, CompileError>>map(index -> {
