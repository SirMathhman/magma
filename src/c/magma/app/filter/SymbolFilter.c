package magma.app.filter;import java.util.function.Predicate;import java.util.stream.IntStream;public class SymbolFilter implements Predicate<String> {@Override
