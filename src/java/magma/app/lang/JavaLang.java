...
public class JavaLang {
    ...
    private static OrRule createJavaRootSegmentRule() {
        return new OrRule(List.of(
                ...
                createJavaCompoundRule(CommonLang.CLASS_TYPE, "class "),
                createJavaCompoundRule(CommonLang.RECORD_TYPE, "record "),
                createJavaCompoundRule(CommonLang.INTERFACE_TYPE, "interface "),
